const PowerOfInfluence = () => {
  return (
    <section className="py-16 px-8 lg:px-16 xl:px-24 mx-auto space-y-4">
      <h2 className="text-2xl lg:text-3xl xl:text-4xl leading-tight montserrat-black">
        Harness the <span className="text-green-700">Power of Influence</span>
      </h2>
...
export default PowerOfInfluence;
