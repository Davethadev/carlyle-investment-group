        ...
        {entries.map((entry, index) => {
          ...
          return (
            <div key={index} className="relative">
              <div className="absolute bg-green-700 z-10 left-0.5 top-0.5 w-full h-[356px]"></div>
              <article className="border border-green-700 relative z-20 p-4 space-y-4 w-full h-[356px] bg">
